...
class Sd_Contributors {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sd_Contributors_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SD_CONTRIBUTORS_VERSION' ) ) {
			$this->version = SD_CONTRIBUTORS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'sd-contributors';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Sd_Contributors_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Sd_Contributors_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sd_Contributors_Loader    Orchestrates the hooks of the plugin.
	 */
